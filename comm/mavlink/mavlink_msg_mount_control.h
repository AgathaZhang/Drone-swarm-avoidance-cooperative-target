...
#define MAVLINK_MSG_ID_MOUNT_CONTROL_LEN 16
#define MAVLINK_MSG_ID_MOUNT_CONTROL_MIN_LEN 16
#define MAVLINK_MSG_ID_157_LEN 16
#define MAVLINK_MSG_ID_157_MIN_LEN 16

#define MAVLINK_MSG_ID_MOUNT_CONTROL_CRC 24
#define MAVLINK_MSG_ID_157_CRC 24
...
#define MAVLINK_MESSAGE_INFO_MOUNT_CONTROL { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_mount_control_t, target_system) }, \
         ...
         { "zoom_speed", NULL, MAVLINK_TYPE_INT8_T, 0, 14, offsetof(mavlink_mount_control_t, zoom_speed) }, \
         { "save_position", NULL, MAVLINK_TYPE_UINT8_T, 0, 15, offsetof(mavlink_mount_control_t, save_position) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MOUNT_CONTROL { \
 ...
 * @param zoom_speed  zoom speed (-7 ~ +7).
...
static inline uint16_t mavlink_msg_mount_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, int32_t input_a, int32_t input_b, int32_t input_c, int8_t zoom_speed, uint8_t save_position)
{
    ...
    _mav_put_int8_t(buf, 14, zoom_speed);
    _mav_put_uint8_t(buf, 15, save_position);
...
{
    return mavlink_msg_mount_control_pack(system_id, component_id, msg, mount_control->target_system, mount_control->target_component, mount_control->input_a, mount_control->input_b, mount_control->input_c, mount_control->zoom_speed, mount_control->save_position);
}
...
{
    return mavlink_msg_mount_control_pack_chan(system_id, component_id, chan, msg, mount_control->target_system, mount_control->target_component, mount_control->input_a, mount_control->input_b, mount_control->input_c, mount_control->zoom_speed, mount_control->save_position);
}
...
static inline void mavlink_msg_mount_control_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, int32_t input_a, int32_t input_b, int32_t input_c, int8_t zoom_speed, uint8_t save_position)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MOUNT_CONTROL_LEN];
    _mav_put_int32_t(buf, 0, input_a);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mount_control_send(chan, mount_control->target_system, mount_control->target_component, mount_control->input_a, mount_control->input_b, mount_control->input_c, mount_control->zoom_speed, mount_control->save_position);
#else
 ...
 */
static inline void mavlink_msg_mount_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, int32_t input_a, int32_t input_b, int32_t input_c, int8_t zoom_speed, uint8_t save_position)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field zoom_speed from mount_control message
 *
 * @return  zoom speed (-7 ~ +7).
 */
static inline int8_t mavlink_msg_mount_control_get_zoom_speed(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mount_control_decode(const mavlink_message_t* msg, mavlink_mount_control_t* mount_control)
{
    ...
    mount_control->zoom_speed = mavlink_msg_mount_control_get_zoom_speed(msg);
